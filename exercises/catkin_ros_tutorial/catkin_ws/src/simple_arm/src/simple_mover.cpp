#include "ros/ros.h"
#include "std_msgs/Float64.h"           // data struct of messages being published
...
int main(int argc, char** argv)
{
    ...
    // Create a handle to the arm_mover node - to communicate with RosMaster
    ros::NodeHandle n;
    ...
    // Set loop frequency of 10Hz - rate at which information is published
    ...
    while (ros::ok()) {
        ...
        // Set the arm joint angles - with predefined angular velocity
        ...
        // Sleep for the time remaining - ensures rate is exactly 10 Hz is reached
        loop_rate.sleep();
    }
