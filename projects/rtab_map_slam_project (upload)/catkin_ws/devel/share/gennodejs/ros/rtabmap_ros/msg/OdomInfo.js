...
class OdomInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('guessVelocity')) {
        this.guessVelocity = initObj.guessVelocity
      }
      else {
        this.guessVelocity = new geometry_msgs.msg.Transform();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [guessVelocity]
    bufferOffset = geometry_msgs.msg.Transform.serialize(obj.guessVelocity, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [guessVelocity]
    data.guessVelocity = geometry_msgs.msg.Transform.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.guessVelocity !== undefined) {
      resolved.guessVelocity = geometry_msgs.msg.Transform.Resolve(msg.guessVelocity)
    }
    else {
      resolved.guessVelocity = new geometry_msgs.msg.Transform()
    }
