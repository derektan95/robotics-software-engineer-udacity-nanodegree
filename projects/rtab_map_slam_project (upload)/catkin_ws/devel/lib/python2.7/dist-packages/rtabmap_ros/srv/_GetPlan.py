...
"""autogenerated by genpy from rtabmap_ros/GetPlanRequest.msg. Do not edit."""
import sys
...
class GetPlanRequest(genpy.Message):
  ...
  _type = "rtabmap_ros/GetPlanRequest"
...
def _get_struct_i3I():
    ...
    return _struct_i3I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rtabmap_ros/GetPlanResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPlanResponse(genpy.Message):
  ...
  _type = "rtabmap_ros/GetPlanResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """rtabmap_ros/Path plan
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.plan.nodeIds))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.plan.nodeIds = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.plan.poses = []
