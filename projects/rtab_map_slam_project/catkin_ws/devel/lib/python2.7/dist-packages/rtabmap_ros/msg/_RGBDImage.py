...
uint8[] data"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','sensor_msgs/CameraInfo','sensor_msgs/Image','sensor_msgs/Image','sensor_msgs/CompressedImage','sensor_msgs/CompressedImage','rtabmap_ros/KeyPoint[]','rtabmap_ros/Point3f[]','uint8[]','rtabmap_ros/GlobalDescriptor']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.rgb_camera_info.D))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.depth_camera_info.D))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.rgb_camera_info.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.rgb_camera_info.distortion_model = str[start:end].decode('utf-8')
      else:
      ...
      self.rgb_camera_info.D = struct.unpack(pattern, str[start:end])
      start = end
      end += 72
      ...
      if python3:
        self.depth_camera_info.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.depth_camera_info.distortion_model = str[start:end].decode('utf-8')
      else:
      ...
      self.depth_camera_info.D = struct.unpack(pattern, str[start:end])
      start = end
      end += 72
      ...
      if python3:
        self.rgb_compressed.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.rgb_compressed.format = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.depth_compressed.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.depth_compressed.format = str[start:end].decode('utf-8')
      else:
