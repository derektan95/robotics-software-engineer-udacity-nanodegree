...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetMap2-request>)))
  ...
  (cl:format cl:nil "~%bool global~%bool optimized~%bool with_images~%bool with_scans~%bool with_user_data~%bool with_grids~%bool with_words~%bool with_global_descriptors~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetMap2-request)))
  "Returns full string definition for message of type 'GetMap2-request"
  (cl:format cl:nil "~%bool global~%bool optimized~%bool with_images~%bool with_scans~%bool with_user_data~%bool with_grids~%bool with_words~%bool with_global_descriptors~%~%~%"))
