...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-msg:<Path> is deprecated: use rtabmap_ros-msg:Path instead.")))
...
(cl:defmethod nodeIds-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:nodeIds-val is deprecated.  Use rtabmap_ros-msg:nodeIds instead.")
  (nodeIds m))
