...
(cl:defmethod cl:initialize-instance :after ((m <EnvSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EnvSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-msg:<EnvSensor> is deprecated: use rtabmap_ros-msg:EnvSensor instead.")))
...
(cl:defmethod value-val ((m <EnvSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:value-val is deprecated.  Use rtabmap_ros-msg:value instead.")
  (value m))
