...
(cl:defmethod cl:initialize-instance :after ((m <GlobalDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-msg:<GlobalDescriptor> is deprecated: use rtabmap_ros-msg:GlobalDescriptor instead.")))
...
(cl:defmethod info-val ((m <GlobalDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:info-val is deprecated.  Use rtabmap_ros-msg:info instead.")
  (info m))
