...
(cl:defmethod cl:initialize-instance :after ((m <GetNodeData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNodeData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<GetNodeData-request> is deprecated: use rtabmap_ros-srv:GetNodeData-request instead.")))
...
(cl:defmethod images-val ((m <GetNodeData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:images-val is deprecated.  Use rtabmap_ros-srv:images instead.")
  (images m))

(cl:ensure-generic-function 'scan-val :lambda-list '(m))
(cl:defmethod scan-val ((m <GetNodeData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:scan-val is deprecated.  Use rtabmap_ros-srv:scan instead.")
  (scan m))

(cl:ensure-generic-function 'grid-val :lambda-list '(m))
(cl:defmethod grid-val ((m <GetNodeData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:grid-val is deprecated.  Use rtabmap_ros-srv:grid instead.")
  (grid m))

(cl:ensure-generic-function 'user_data-val :lambda-list '(m))
(cl:defmethod user_data-val ((m <GetNodeData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-srv:user_data-val is deprecated.  Use rtabmap_ros-srv:user_data instead.")
  (user_data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNodeData-request>)))
  ...
  "rtabmap_ros/GetNodeDataRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNodeData-request)))
  "Returns string type for a service object of type 'GetNodeData-request"
  "rtabmap_ros/GetNodeDataRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetNodeData-request>)))
  ...
  "910c3a3dc1c436519825ca723762df03")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetNodeData-request)))
  "Returns md5sum for a message object of type 'GetNodeData-request"
  "910c3a3dc1c436519825ca723762df03")
...
(cl:defmethod cl:initialize-instance :after ((m <GetNodeData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNodeData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rtabmap_ros-srv:<GetNodeData-response> is deprecated: use rtabmap_ros-srv:GetNodeData-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNodeData-response>)))
  ...
  "rtabmap_ros/GetNodeDataResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNodeData-response)))
  "Returns string type for a service object of type 'GetNodeData-response"
  "rtabmap_ros/GetNodeDataResponse")
