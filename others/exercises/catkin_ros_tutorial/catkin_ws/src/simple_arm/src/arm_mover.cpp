#include "ros/ros.h"
#include "simple_arm/GoToPosition.h"        // Generated from srv file
#include <std_msgs/Float64.h>

// Global joint publisher variables
ros::Publisher joint1_pub, joint2_pub;

// This function checks and clamps the joint angles to a safe zone (wihin safe boundaries)
    ...
    simple_arm::GoToPosition::Response& res)
{
    ...
    // Move arms to specified position based on request
